...
| `memory_export` |  | `maxSessions`: number, `offset`: number, `full`: boolean | Export memory data as JSON. Defaults to a bounded session page; set full=true for full export. |
